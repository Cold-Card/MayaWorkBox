...
# Author: WangRuiLong
WRL_BatchTool_version = '2.5.3'
'''
Update Log:
    v2.5.3:
        优化 Skin + Copy Weight 模块
    v2.5.2:
...
class MainPY():
    ...
    def skin_copy_weight(self,*args):
        ...
        try:
            if radio == 'RM_all_to_all_radioButton_ui':
                ...
                for ref_skinNode in ref_skinNodes:
                    ...
                    all_ref_joints.update(ref_skinJnt)
                ref_skinJnts = list(all_ref_joints)
