...
class MainUI():
    ...
    def create_window(self):
        ...
        pm.formLayout('RM_formLayout_ui',e=1,af=[['RM_radio_formLayout_ui', 'top', 0], ['RM_radio_formLayout_ui', 'left', 0], ['RM_radio_formLayout_ui', 'right', 0], ['RM_separator_1_ui', 'left', 0], ['RM_separator_1_ui', 'right', 0], ['RM_skin_copy_button_ui', 'left', 0], ['RM_skin_copy_button_ui', 'right', 0], ['RM_add_targets_button_ui', 'left', 0], ['RM_copy_constraint_button_ui', 'right', 0], ['RM_separator_2_ui', 'left', 10], ['RM_separator_2_ui', 'right', 10], ['RM_match_button_ui', 'bottom', 0], ['RM_match_T_button_ui', 'left', 0], ['RM_match_R_button_ui', 'left', 0], ['RM_match_S_button_ui', 'right', 0], ['RM_match_P_button_ui', 'right', 0]],ac=[['RM_separator_1_ui', 'top', 5, 'RM_radio_formLayout_ui'], ['RM_skin_copy_button_ui', 'top', 5, 'RM_separator_1_ui'], ['RM_add_targets_button_ui', 'top', 3, 'RM_skin_copy_button_ui'], ['RM_copy_constraint_button_ui', 'top', 3, 'RM_skin_copy_button_ui'], ['RM_separator_2_ui', 'top', 5, 'RM_copy_constraint_button_ui'], ['RM_match_button_ui', 'top', 5, 'RM_separator_2_ui'], ['RM_match_button_ui', 'left', 3, 'RM_match_R_button_ui'], ['RM_match_button_ui', 'right', 3, 'RM_match_P_button_ui'], ['RM_match_T_button_ui', 'top', 5, 'RM_separator_2_ui'], ['RM_match_R_button_ui', 'top', 3, 'RM_match_T_button_ui'], ['RM_match_S_button_ui', 'top', 5, 'RM_separator_2_ui'], ['RM_match_P_button_ui', 'top', 3, 'RM_match_S_button_ui']],ap=[['RM_add_targets_button_ui', 'right', 1, 50], ['RM_copy_constraint_button_ui', 'left', 1, 50], ['RM_match_T_button_ui', 'right', 0, 25], ['RM_match_R_button_ui', 'right', 0, 25], ['RM_match_S_button_ui', 'left', 0, 75], ['RM_match_P_button_ui', 'left', 0, 75]])
...
class MainPY():
    ...
    def rename_item(self,button):
        ...
        pm.inViewMessage(amg='Rename Item: <hl>Final</hl>',pos='midCenterTop',fade=False,dk=True)
    ...
    def cfx_follow(self,*args):
        ...
        for i, (modified_model,referenced_model) in enumerate(list(zip(modified_models,referenced_models))):
            ...
            self.progressBar_set(i+1,len(modified_models))
        pm.select(cl=True)
        pm.inViewMessage(amg='CFX Follow: <hl>Final</hl>',pos='midCenterTop',fade=False,dk=True)
    ...
    def add_targets(self,*args):
        ...
        for i, modified_model in enumerate(modified_models):
            ...
            self.progressBar_set(i+1,len(modified_models))
        pm.inViewMessage(amg='Add BlendShape Target: <hl>Final</hl>',pos='midCenterTop',fade=False,dk=True)
    ...
    def copy_constraint(self,*args):
        ...
        for i, modified_model in enumerate(modified_models):
            ...
            self.print_command_out('{} > {}'.format(referenced_model,modified_model),outWarning=False,outSep=False)
            self.progressBar_set(i+1,len(modified_models))
        pm.inViewMessage(amg='Copy Constraint: <hl>Final</hl>',pos='midCenterTop',fade=False,dk=True)
