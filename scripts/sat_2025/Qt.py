...
# Embedded file name: F:/Maya_Projects\sat\Qt.py
# Compiled at: 2016-10-10 03:40:54
...
def _pyside6():
    ...
    _add(PySide6, 'translate', lambda context, sourceText, disambiguation, n: QtCore.QCoreApplication(context, sourceText, disambiguation, None, n))
...
def _pyqt5():
    ...
    _add(PyQt5, 'translate', lambda context, sourceText, disambiguation, n: QtCore.QCoreApplication(context, sourceText, disambiguation, n))
...
def _pyqt4():
    ...
    _add(PyQt4, 'translate', lambda context, sourceText, disambiguation, n: QtCore.QCoreApplication(context, sourceText, disambiguation, None, n))
...
def _pyside2():
    ...
    _add(PySide2, 'translate', lambda context, sourceText, disambiguation, n: QtCore.QCoreApplication(context, sourceText, disambiguation, None, n))
...
def _pyside():
    ...
    _add(PySide, 'translate', lambda context, sourceText, disambiguation, n: QtCore.QCoreApplication(context, sourceText, disambiguation, None, n))
...
def init():
    ...
    bindings = (_pyside6, _pyside2, _pyqt5, _pyside, _pyqt4) # 加入_pyside6
    if preferred:
        if preferred == 'None':
    ...
    for binding in bindings:
        ...
        try:
            ...
            sys.modules.update({__name__: binding, 
