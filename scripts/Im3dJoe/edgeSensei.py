...
def X95():
    edges = mc.ls(fl=True, sl=True)
    mc.polySelectConstraint(m=2, w=2, type=0x8000)
    mc.polySelectConstraint(disable=True)
...
def EdgeSensei():
    ...
    edge_window = mc.window("EdgeSenseiWindow", title="EdgeSensei v1.5", widthHeight=(320, 1100),s = 1 ,mxb = False, mnb = False)
    ...
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Slide",rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X6o())
    mc.setParent("..")
    mc.rowColumnLayout(nc=9, cw=[(1, 50), (2, 20), (3, 65), (4, 7), (5, 75), (6, 7), (7, 50), (8, 7), (9, 65)])
    mc.text(l="")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Connet 90",rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: Xl9())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Sharp Corner",rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X23())
    mc.setParent("..")
    ...
    mc.text(l=" Select")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Border",rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X99())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Contiguous",rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X62(30))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Shortest",rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X92())
    mc.setParent("..")
    ...
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="+", rpt=1, bgc=(0.08, 0.18, 0.38), c=lambda: XI9("plus"))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="-", rpt=1, bgc=(0.08, 0.38, 0.28), c=lambda: XI9("minus"))
    mc.text(l=" |")
    mc.iconTextButton(style="textOnly", label="Ring",rpt=1, bgc=(0.18, 0.18, 0.18), c="mc.SelectEdgeRingSp()")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="+", rpt=1, bgc=(0.08, 0.18, 0.38), c=lambda: X32())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="-", rpt=1, bgc=(0.08, 0.38, 0.28), c=lambda: X86())
    mc.setParent("..")
    ...
    mc.text(l="Average")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Smooth", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X94())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Even", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: XO7())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Spread",rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X95())
    mc.text(l="")
    ...
    mc.text(l="      3D")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="1", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X9l(1))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="2", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X9l(2))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="3", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X9l(3))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="--", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X9l(0))
    mc.setParent("..")
    mc.rowColumnLayout(nc=9, cw=[(1, 50), (2, 20), (3, 50), (4, 5), (5, 50), (6, 5), (7, 50), (8, 5), (9, 50)])
    mc.text(l="      2D")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="1", rpt=1, bgc=(0.22, 0.22, 0.18), c=lambda: Xl8(1))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="2", rpt=1, bgc=(0.22, 0.22, 0.18), c=lambda: Xl8(2))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="3", rpt=1, bgc=(0.22, 0.22, 0.18), c=lambda: Xl8(3))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="--", rpt=1, bgc=(0.22, 0.22, 0.18), c=lambda: Xl8(0))
    mc.text(l="", h=5)
    mc.setParent("..")
    mc.rowColumnLayout(nc=9, cw=[(1, 50), (2, 20), (3, 50), (4, 5), (5, 50), (6, 5), (7, 50), (8, 5), (9, 50)])
    mc.text(l="      Edit")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Inflate", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X48())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Tension", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X7l())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="UnBevel", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: X8O())
    mc.text(l="")
    ...
    mc.text(l="  Extend")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="L", rpt=1,bgc=(0.08, 0.18, 0.38), c=lambda: X3l('L',100))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="R", rpt=1,bgc=(0.08, 0.38, 0.28), c=lambda: X3l('R',100))
    mc.text(l="")
    ...
    mc.text(l="     Curl")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="L", rpt=1,bgc=(0.08, 0.18, 0.38), c=lambda: X3l('L',4))
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="R", rpt=1,bgc=(0.08, 0.38, 0.28), c=lambda: X3l('R',4))
    mc.setParent("..")
    mc.text(l="",h=2)
    mc.setParent("..")
    mc.setParent("..")
    ...
    mc.text(l="")
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="90", bgc=(0.18, 0.18, 0.18), c=lambda: X84())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="180", bgc=(0.18, 0.18, 0.18), c=lambda: Xo9())
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="360", bgc=(0.18, 0.18, 0.18), c=lambda: X5I())
    mc.text(l="")
    ...
    mc.text(l="")
    mc.text(l="")
    mc.checkBox("evenRoundPivotSnap", label="Pivot Snap Type", value=0, cc=lambda _: Xl2())
    ...
    mc.text(l="")
    mc.iconTextButton(style="textOnly", label="Split", rpt=1, bgc=(0.18, 0.18, 0.18), c=lambda: XO3())
    mc.text(l="",h=2)
    mc.setParent("..")
    mc.text(l="",h=1)
    mc.setParent("..")
    ...
    mc.text(l="", h=3)
    mc.button(bgc=[0.2, 0.2, 0.2], label="Check", h=23, c=lambda: X76("IbL"))
    mc.text(l="", h=3)
    mc.button(bgc=[0.2, 0.2, 0.2], label="Split", h=23, c=lambda: XoI())
    mc.setParent('..')
    mc.text(l="",h=1)
    mc.setParent('..')
    ...
    mc.setParent("..")
    mc.floatSliderGrp("lockEdgeSlider", v=0.95, min=0.001, max=0.999, s=0.01, cw3=[50, 40, 0], label="Ratio   ", field=True, dc=lambda: X36())
    mc.rowColumnLayout(nc=7, cw=[(1, 45), (2, 7), (3, 40), (4, 7),(5, 95), (6, 5),(7, 95)])
    mc.text(l="Length")
    mc.text(l="", h=3)
    mc.floatField("lastLockEdgelength",  v = 0.02, pre=3)
    mc.text(l="", h=3)
    mc.iconTextButton(style="textOnly",label="Ratio", rpt=1, bgc=(0.18, 0.18, 0.18),c=lambda: X25())
    mc.text(l="", h=3)
    mc.iconTextButton(style="textOnly",label="Length", rpt=1,bgc=(0.18, 0.18, 0.18),c=lambda: X58())
    mc.text(l="",h=2)
    mc.setParent("..")
    mc.setParent("..")
    mc.text(l="",h=4)
    ...
    mc.text(l="",h=2)
    mc.iconTextButton(style="textOnly", label="check", bgc=(0.18, 0.18, 0.18), c=lambda: X76("RE"))
    mc.text(l="  |  ",h=2)
    mc.iconTextButton(style="textOnly", label="A", bgc=(0.08, 0.18, 0.38), c=lambda: X75('A'))
    mc.text(l="",h=2)
    mc.iconTextButton(style="textOnly", label="Mid", bgc=(0.18, 0.18, 0.18), c=lambda: X75('M'))
    mc.text(l="",h=2)
    mc.iconTextButton(style="textOnly", label="B", bgc=(0.08, 0.38, 0.28), c=lambda: X75('B'))
    mc.setParent("..")
    mc.text(l="",h=1)
    mc.setParent('..')
    ...
    mc.text(l="", h=3)
    mc.button(bgc=[0.2, 0.2, 0.2], label="Collapse", h=23, c=lambda: X66())
    mc.setParent('..')
    mc.text(l="",h=1)
    mc.setParent('..')
    ...
    mc.text(l ='Type')
    mc.text(l ='')
    mc.radioButtonGrp('curveType', nrb=2, sl=1, labelArray2=['Bezier', 'Nurbs'], cw = [(1,90),(2,70)],cc=lambda _: X45())
    mc.setParent( '..' )
    mc.rowColumnLayout(nc=10 ,cw=[(1,1),(2,50),(3,10),(4,50),(5,5),(6,50),(7,5),(8,50),(9,5),(10,95)])
    mc.text(l ='')
    mc.text(l ='Options')
    mc.text(l ='')
    mc.checkBox('makeArc', label= "Arc" ,v = 1, cc=lambda _: X9I())
    mc.text(l ='')
    mc.checkBox('snapCurve', label= "Snap" ,v = 1, cc=lambda _: X77())
    mc.text(l ='')
    ...
    mc.text(l ='')
    mc.iconTextButton(style="textOnly", l= 'Create',bgc=(0.18, 0.18, 0.18),  c=lambda: XI4())
    mc.text(l ='')
    mc.iconTextButton(style="textOnly", l= 'Done', bgc=(0.18, 0.18, 0.18), c=lambda: X98())
    mc.text(l ='')
    mc.setParent( '..' )
    mc.text(l="",h=2)
