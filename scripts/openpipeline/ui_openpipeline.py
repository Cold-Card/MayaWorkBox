...
def build_openpipeline_ui(main_window):
    ...
    btn_set_root.setProperty("white", 'true')
    ...
    btn_new.setProperty("white", 'true')
    ...
    btn_addtype.setProperty("green", 'true')
    ...
    btn_deltype.setProperty("red", 'true')
    ...
    self.btn_create_asset.setProperty("green", 'true')
    self.btn_delete_asset.setProperty("red", 'true')
    ...
    self.btn_add_sub.setProperty("green", 'true')
    ...
    self.btn_save_new_version.setProperty("white", 'true')
    ...
    self.btn_set_master.setProperty("green", 'true')
