...
from openpipeline.ui_framework.widgets.widgets import Widgets
...
def build_openpipeline_ui(main_window):
    ...
    self = main_window
    _widgets.apply_openpipeline_style(self)
    ...
    self.root_path_label.setStyleSheet(' color:#5285A6; font: bold; ')
    self.root_path_label.setFixedWidth(320)

    btn_set_root = QtWidgets.QPushButton(u' [设置项目路径] ')
    btn_set_root.setProperty("primary", 'true')
    #btn_set_root.setStyleSheet("font: bold; {} color: black;".format(_widgets.button_bgc))
    ...
    #btn_new.setStyleSheet("font: bold; {} color: black;".format(_widgets.button_bgc))
    ...
    btn_addtype.setProperty("primary_green", 'true')
    btn_addtype.setStyleSheet("font: 20px;")
    ...
    btn_deltype.setProperty("primary_red", 'true')
    btn_deltype.setStyleSheet("font: 20px;")
    ...
    self.btn_create_asset.setProperty("primary_green", 'true')
    self.btn_delete_asset.setProperty("primary_red", 'true')
    ...
    self.info_label.setStyleSheet('color:#FFD700; font: bold 12px;')
    ...
    self.btn_add_sub.setProperty("primary_green", 'true')
    #self.btn_add_sub.setStyleSheet("font: bold 12px;{} color: green;".format(_widgets.button_bgc))
    ...
    self.version_list.itemClicked.connect(self.on_version_clicked)
    ...
    self.btn_save_new_version.setProperty("primary", 'true')
    #self.btn_save_new_version.setStyleSheet("font: bold 12px;{} color: red;".format(_widgets.button_bgc))
    ...
    self.btn_set_master.setProperty("primary_green", 'true')
    ...
    subtype_frame.setMinimumHeight(155)
    vsplitter.setSizes([155, 600])
    ...
    self.preview_label.setMinimumSize(200, 130)
    self.preview_label.setAlignment(QtCore.Qt.AlignCenter)
    self.preview_label.setFrameStyle(QtWidgets.QFrame.Box | QtWidgets.QFrame.Sunken)
    self.preview_label.setStyleSheet("background-color: #272727; color: #888; border: 1px solid #272727; border-radius: 3px;")
