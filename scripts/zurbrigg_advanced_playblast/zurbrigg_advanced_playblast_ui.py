...
#
# Copyright (C) 2023 Chris Zurbrigg. All rights reserved.
###############################################################################
...
from zurbrigg_advanced_playblast.zurbrigg_advanced_playblast_presets import ZurbriggPlayblastCustomPresets, ZurbriggShotMaskCustomPresets
...
class ZurbriggAdvancedPlayblastUtils(object):
    ...
    def get_temp_file_format(self):
        return cmds.ZurbriggAP(q=True, tf=True)[0]

    @classmethod
    def set_temp_file_format(self, file_format):
        cmds.ZurbriggAP(e=True, tf=file_format)

    @classmethod
    def is_temp_format_env_set(cls):
        return cmds.ZurbriggAP(tfe=True)[0]
...
class ZurbriggLineEdit(QtWidgets.QLineEdit):
    ...
    def show_context_menu(self, pos):
        ...
        if self.le_type == ZurbriggLineEdit.TYPE_PLAYBLAST_OUTPUT_PATH:
            lookup = ZurbriggLineEdit.PLAYBLAST_OUTPUT_PATH_LOOKUP
            ...
            lookup = ZurbriggLineEdit.PLAYBLAST_OUTPUT_FILENAME_LOOKUP
            ...
            lookup = ZurbriggLineEdit.SHOT_MASK_LABEL_LOOKUP
...
class ZurbriggPlayblastWidget(QtWidgets.QWidget):
    ...
    def refresh_cameras(self):
        ...
        self.camera_select_cmb.addItems(ZurbriggAdvancedPlayblastUtils.cameras_in_scene(self.camera_select_hide_defaults_cb.isChecked(), True))
