...
def getAttrList():
    ...
    attrData.append(attrNode(
    longName='handleNodeDropCallback',
    shortName='hnd', 
    type='script',
    mode='c',
    value=None,
