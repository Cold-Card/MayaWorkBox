...
package_name = 'AttrBatch'
icon_name = 'AttrBatchIcon.png'
shelf_button_name = 'AttrBatch'
        ...
        for file in files:
            ...
            if source_file != destination_file:
                try:
                    ...
                    print("File copied: {} to {}".format(source_file, destination_file))
                except Exception as e:
                    cmds.warning("FAILED TO COPY FILE {}, {}". format(source_file, str(e)))
            else:
                cmds.warning("Looks like you already manually copied files to the maya/scripts folder! Skipping the file {}".format(source_file))
