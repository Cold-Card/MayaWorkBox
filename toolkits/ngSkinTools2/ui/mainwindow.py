...
def build_menu(parent, actions):
    ...
    display_mode_menu = sub.addMenu("影响物显示方式")
    display_mode_menu.addAction(actions.influences_display_hierarchy)
    display_mode_menu.addAction(actions.influences_display_flat)
