...
class Actions(Object):
    ...
    def __init__(self, parent, session):
        ...
        (
            self.influences_display_mode_group,
            self.influences_display_hierarchy,
            self.influences_display_flat,
        ) = influencesview.build_influences_display_mode_actions(parent)
